...
# recipe_array = [
#   [
#     [name, boil_length, ferm_temp],
#     [
#       [name, usage, quantity, duration],
#       [name, usage, quantity, duration],
#       [name, usage, quantity, duration],
#       [name, usage, quantity, duration]
#     ]
...
#   recipe.each do | recipe_args, recipe_ingredient_args |
#     recipe = Recipe.create(name, boil_length, ferm_temp)
#     recipe.save
#     ri_args.each do | name, usage, quantity, duration |
#       recipe_ingredient = recipe.recipe_ingredients.create(usage, quantity, duration)
#       ingr = Ingredient.where(name: params[:ingredient][:name]).first
#       recipe_ingredient.ingredient = ingr
