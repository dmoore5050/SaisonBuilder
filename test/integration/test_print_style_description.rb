...
class TestPrintStyleDescription < MiniTest::Unit::TestCase
...
of style and its beautiful quenching character. Traditionally
...
the summer sun due to their crisp, refreshing character.

    Because they were generally brewed with ingredients the farm
...
in frequency, both in the US and Belgium.

    The style's popularity has skyrocketed in recent years, pushed
by a number of breweries in both the US and Belgium brewing exclusively
saisons. Notable Saison can be found from Stillwater, Prairie, the
Bruery, and Southampton breweries in the US among many others, and from
Dupont, Fantome, Brasserie Thierez, and an array of others in Belgium
and France. Additionally, the Hopfenstark brewery in Montreal has
